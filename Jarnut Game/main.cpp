...
int main()
{
	...
	platforms.push_back(Platform(NULL, sf::Vector2f(650.0f, 30.0f), sf::Vector2f(320.0f, 470.0f))); //floor
	//platforms.push_back(Platform(NULL, sf::Vector2f(260.0f, 30.0f), sf::Vector2f(120.0f, 340.0f)));
	platforms.push_back(Platform(NULL, sf::Vector2f(260.0f, 30.0f), sf::Vector2f(500.0f, 340.0f)));
	//platforms.push_back(Platform(NULL, sf::Vector2f(240.0f, 30.0f), sf::Vector2f(320.0f, 210.0f)));
	//platforms.push_back(Platform(NULL, sf::Vector2f(240.0f, 30.0f), sf::Vector2f(120.0f, 100.0f)));
	//platforms.push_back(Platform(NULL, sf::Vector2f(240.0f, 30.0f), sf::Vector2f(500.0f, 100.0f)));

	for (int i = 0; i < 20; i++)
	{
		platforms.push_back(Platform(NULL, sf::Vector2f(240.0f, 30.0f), sf::Vector2f(320.0f, 80.0f - 200.0f*i)));
		platforms.push_back(Platform(NULL, sf::Vector2f(240.0f, 30.0f), sf::Vector2f(120.0f, 180.0f - 200.0f*i)));
		platforms.push_back(Platform(NULL, sf::Vector2f(240.0f, 30.0f), sf::Vector2f(500.0f, 180.0f - 200.0f*i)));
	}
